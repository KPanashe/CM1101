...
def exit_leads_to(exits, direction):
    ...
    #return rooms[exits["South"]]["Admin"]
...
def print_menu_line(direction, leads_to):
    ...
    #print("GO " + (exit["name"].upper()) + " to " + (exit["description"] )+ ".")
    #print_menu_line("east", "your personal tutor's office")
    #return "Go EAST to your personal tutor's office."
    #print_menu_line("south", "MJ and Simon's room")
    #return "Go SOUTH to MJ and Simon's room."
    #print_menu_line("west", "Car park")
    #return 'Go EAST to the Car Park'
...
def menu(exits):
    ...
    while True:
        ...
        user_input = input("> ")
        # Normalise the input
        #normalise_user_input = normalise_input(user_input)
